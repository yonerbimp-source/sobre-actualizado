...
renderPendingVoiceNotes('remove');
renderPendingVoiceNotes('edit');
if ('serviceWorker' in navigator) navigator.serviceWorker.register('sw(1).js').catch(() => {});
